...
mkdir $folder
cd $folder
wget https://github.com/siemenstutorials/v2bserver/releases/download/latest/v2bserver
wget https://github.com/v2fly/v2ray-core/releases/latest/download/v2ray-linux-64.zip

unzip v2ray-linux-64.zip
chmod 755 *
nohup `pwd`/v2bserver -api=$api -token=$key -node=$nodeId -license=$license -syncInterval=$syncInterval > v2bserver.log 2>&1 &
echo '部署完成'
sleep 3
cat v2bserver.log
